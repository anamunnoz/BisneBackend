...
{
    public class TiendaByIdDataLoader : BatchDataLoader<int, Tienda>
    {
        private readonly IDbContextFactory<MyDbContext> _dbContextFactory;

        public TiendaByIdDataLoader(
        ...
        protected override async Task<IReadOnlyDictionary<int, Tienda>> LoadBatchAsync(
