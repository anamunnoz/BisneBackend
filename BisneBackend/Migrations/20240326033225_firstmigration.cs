        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    direccion_envio = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    horario = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Oferta_Etiqueta_etiquetaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuarioOfertaFavs", x => new { x.usuarioId, x.ofertaId });
                    table.ForeignKey(
                        name: "FK_UsuarioOfertaFavs_Oferta_ofertaId",
                        column: x => x.ofertaId,
                        principalTable: "Oferta",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsuarioOfertaFavs_UsuarioRegistrado_usuarioId",
                        column: x => x.usuarioId,
                        principalTable: "UsuarioRegistrado",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioOfertaFavs_ofertaId",
                table: "UsuarioOfertaFavs",
                column: "ofertaId");
